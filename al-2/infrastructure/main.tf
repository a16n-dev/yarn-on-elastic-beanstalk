...
resource aws_elastic_beanstalk_environment app_env {
  name                = "Example"
  description         = "Elastic Beanstalk Environment running AL2, demostrating how to install dependencies with yarn"
  application         = aws_elastic_beanstalk_application.app.name
  tier                = "WebServer"
  solution_stack_name = "64bit Amazon Linux 2 v5.8.9 running Node.js 18"
